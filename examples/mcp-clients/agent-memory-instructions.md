...
- When calling `memory_recall`, set `agentId` to this client's stable logical identity (for example `claude-code`, `codex`, `cursor`, `gemini-cli`, `grok`, `chat-on-steroids`, or `vscode`).
