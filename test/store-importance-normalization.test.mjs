...
describe("importance normalization", () => {
  ...
  // Regression: "Repeated normalization can invert clamped
  ...
  // Regression: "Read-path normalization diverges from
  ...
  // Regression: "CLI JSON imports without ids still pass
