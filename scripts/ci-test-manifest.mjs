...
export const CI_TEST_MANIFEST = [
  ...
  { group: "core-regression", runner: "node", file: "test/memory-core-assembly.test.mjs", args: ["--test"] },
  { group: "core-regression", runner: "node", file: "test/memory-server-http.test.mjs", args: ["--test"] },
  { group: "core-regression", runner: "node", file: "test/mcp-shared-memory-clients.test.mjs", args: ["--test"] },
  { group: "core-regression", runner: "node", file: "test/openclaw-remote-mode.test.mjs", args: ["--test"] },
